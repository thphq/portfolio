...
const jsonLd = {
  ...
  description: 'Vikas Meena, born in Kota Rajasthan, is a Senior Product Manager and startup co-founder. A business graduate from IIM Bangalore with Computer Science major and Mathematics minor from NITK. He is very driven and passionate with a bias to action and go-getter mentality. Vikas is passionate about technology and believes in democratizing technology to solve world problems. He is a seasoned product professional who worked at the world\'s largest matchmaking company Matrimony.com to make it a safer place for all participants. With 7+ years of experience building 0-1 products, scaling platforms to 40L+ users, and driving ₹27L+ revenue impact, he loves problem-solving and using technology to democratize solutions.'
};
